<?php
require_once '../Controller/Enroll_course_controller.php'; // Load courses

if (session_status() === PHP_SESSION_NONE) {
    session_start();
}
if (isset($_SESSION['MemberID'])) {
    error_log("trainee table with MemberID: " . $_SESSION['MemberID']);
} else {
...
<body>
    ...
    <?php foreach ($courses as $course): ?>
        ...
        <a href="course_details_view.php?courseId=<?php echo $course['course_id']; ?>" style="text-decoration: none; color: inherit;">
            ...
            <form method="POST" action="../Controller/Enroll_course_controller.php">
    ...
    <?php endforeach; ?>
<?php else: ?>
    <p style="text-align: center;">No courses available for enrolling.</p>
<?php endif; ?>
