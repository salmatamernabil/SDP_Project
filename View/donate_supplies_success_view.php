...
error_log("[DEBUG] Receipt data retrieved from session: " . print_r($receiptData, true));
...
<body>
    ...
    <p><strong>Number of Staplers:</strong> <?php echo htmlspecialchars($receiptData['staplerCount']); ?></p>
    <p><strong>Brand:</strong> <?php echo htmlspecialchars($receiptData['brand']); ?></p>
