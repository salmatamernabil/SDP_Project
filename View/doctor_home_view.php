    ...
    <div class="sidebar">
        <div class="profile">
            <a href="doctor_home_view.php">
                <img src="https://static-00.iconduck.com/assets.00/profile-icon-512x512-w0uaq4yr.png" alt="Profile" style="width:40px; height:40px;"> <!-- Profile Icon -->
            </a>
        </div>
        <div class="notification">
            <a href="approve_accounts_view.php">
                <img src="https://cdn-icons-png.flaticon.com/512/3239/3239958.png" alt="Notification" style="width:20px; height:20px;"> <!-- Notification Icon -->
                Notifications
            </a>
        </div>
        <a href="all_courses.php">See All Courses</a>
        <a href="doctor.php">Instruct Course</a>
