...
<body>
    ...
    <div class="content">
        ...
        <form action="../Controller/types_controller.php" method="POST">
        ...
        <select name="surgery_type" id="surg">
    ...
    <div id="Sleeve" class="surgery-info common-sleeve-options">
        ...
        <input type="radio" id="Stapler1" name="stapler_type" value="Johnson">
        <label for="Stapler1"> Johnson</label><br>
        <input type="radio" id="Stapler2" name="stapler_type" value="Med Tronic">
        <label for="Stapler2"> Med Tronic</label><br>
        <input type="radio" id="Stapler3" name="stapler_type" value="Easy surj">
        <label for="Stapler3"> Easy surj</label><br>
        <input type="radio" id="Stapler4" name="stapler_type" value="Pancer">
        <label for="Stapler4"> Pancer</label><br>
        <input type="radio" id="Stapler5" name="stapler_type" value="Feing">
        <label for="Stapler5"> Feing</label><br>
        <input type="radio" id="Stapler6" name="stapler_type" value="Touch Stone">
        <label for="Stapler6"> Touch Stone</label><br>
        <input type="radio" id="Stapler7" name="stapler_type" value="Vector">
        <label for="Stapler7"> Vector</label><br>
        <input type="radio" id="Stapler8" name="stapler_type" value="Others">
        <label for="Stapler8"> Others</label><br>
        <br>
        </div>
        <label for="number_of_stapler"><h4> Number of Staplers:</h4></label>
        <input type="number" id="number_of_stapler" name="number_of_staplers" value="Number of Staplers"min="1">
        <br>

        <h4>Color of Staplers</h4>
        <label for="Color_of_stapler"> Black:</label>
        <input type="number" id="Black" name="black_staplers" value="Black "><br>
        <label for="Color_of_stapler"> Green:</label>
        <input type="number" id="Green" name="green_staplers" value="Green "><br>
        <label for="Color_of_stapler"> Yellow:</label>
        <input type="number" id="Yellow" name="yellow_staplers" value="Yellow "><br>
        <label for="Color_of_stapler"> Blue:</label>
        <input type="number" id="Blue" name="blue_staplers" value="Blue "><br>
        <label for="Color_of_stapler"> Purple:</label>
        <input type="number" id="Purple" name="purple_staplers" value="Purple "><br>
        <label for="Color_of_stapler"> Tan:</label>
        <input type="number" id="Tan" name="tan_staplers" value="Tan "><br>

        <h4>Type of Reinforcement</h4>
        <div class="radio-group">
        <input type="radio" id="Switcher" name="reinforcement_type" value="Switcher">
        <label for="Switcher">Switcher</label><br>
        <input type="radio" id="Envagination" name="reinforcement_type" value="Envagination">
        <label for="Envagination">Envagination</label><br>
        <input type="radio" id="Sotcher" name="reinforcement_type" value="Sotcher">
        <label for="Sotcher">Sotcher Full Through</label><br>
        <input type="radio" id="Butrising" name="reinforcement_type" value="Butrising_Material">
        <label for="Butrising">Butrising Material</label><br>
        <input type="radio" id="glue" name="reinforcement_type" value="Glue">
        <label for="glue">Glue</label><br>
        </div>

        <h4>Gastric Tube Fixation</h4>
        <div class="radio-group">
        <input type="radio" id="NoFixation" name="gastric_fixation" value="No">
        <label for="NoFixation">No</label><br>
        <input type="radio" id="Omenopixy" name="gastric_fixation" value="Omenopixy">
        <label for="Omenopixy">Omenopixy</label><br>
        <input type="radio" id="Peseroe" name="gastric_fixation" value="Peseroe_Fixation">
        <label for="Peseroe">Peseroe Fixation</label><br>
        <input type="radio" id="none" name="gastric_fixation" value="None">
        <label for="none">None</label><br>
        </div>

        <h4>Hiatus Hernia</h4>
        <div class="radio-group">
        <input type="radio" id="NoHernia" name="hiatus_hernia" value="No">
        <label for="NoHernia">No</label><br>
        <input type="radio" id="y" name="hiatus_hernia" value="Yes without Correction">
        <label for="y">Yes without Correction</label><br>
        <input type="radio" id="yc" name="hiatus_hernia" value="Yes with Correction">
        ...
        <div id="other-surgery-text">
            ...
            <input type="text" id="other_surgery_details" name="other_surgery_details">
        </div>
    </div>
    ...
    <div id="SASI" class="surgery-info">
        ...
        <input type="number" id="bypassed-intestine" name="bypassed_intestine_length"><br>

        <h4>Length of Whole Intestine</h4>
        <input type="number" id="whole-intestine-sasi" name="whole_intestine_length"><br>
    </div>
       ...
       <div id="RNY" class="surgery-info">
        ...
        <input type="number" id="rgux-limb" name="roux_limb_length"><br>

        <h4>Length of Perial Limb</h4>
        <input type="number" id="perial-limb" name="perial_limb_length"><br>
...
<div id="redo" class="surgery-info">
    ...
    <input type="text" id="type-of-redo" name="redo_type" placeholder="Enter type of redo"><br>
</div>
